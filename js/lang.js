...
const translations = {
  en: {
    ...
    /* PRODUCTS PAGE */
    prod_hero_eyebrow: 'Our expressions',
    prod_hero_title:   'Two tequilas, one soul',
    prod_hero_sub:     'Each bottle is a journey — from the sun-drenched agave fields of Jalisco to your glass.',
    ...
    note_citrus:       'Citrus',
    note_floral:       'Floral',
    note_fresh_agave:  'Fresh Agave',
    note_herbal:       'Herbal',
    note_clean:        'Clean Finish',
    note_vanilla:      'Vanilla',
    note_oak:          'Toasted Oak',
    note_caramel:      'Caramel',
    note_agave:        'Agave',
    note_smoke:        'Light Smoke',
    spec_agave:        'Agave',
    spec_agave_val:    '100% Blue Weber',
    spec_origin:       'Origin',
    spec_origin_val:   'Jalisco, Mexico',
    spec_style:        'Style',
    spec_style_val:    'Unaged / Blanco',
    spec_cert:         'Certification',
    repo_label:        'Reposado Edition · Dark Label',
    repo_desc:         'Aged in carefully selected oak barrels, our Reposado rests until it reaches the perfect balance of agave character and woody warmth. The result is a smooth, amber-tinged spirit with layers of complexity — a tequila that honours the patience of the craftsman.',
    repo_unavailable:  'Currently unavailable',
    repo_soldout:      'Sold Out',
    repo_ageing:       'Ageing',
    repo_ageing_val:   'Oak barrels',
    repo_notify:       'Notify me when available',
    repo_coming_soon:  'Coming back soon',
    lifestyle_eyebrow: 'Born in Jalisco',
    lifestyle_title:   'Where tradition<br>takes flight',
    lifestyle_body:    'Crafted in the heart of Mexico\'s Tequila region, where the agave grows under open skies and every bottle carries the spirit of the land.',
    lifestyle_cta:     'Our story',
    ...
    prod_cta_title:    'Let\'s talk',
    prod_cta_btn:      'Contact us',

    /* CONTACT PAGE */
    contact_hero_eyebrow:  'We\'d love to hear from you',
    contact_hero_title:    'Get in touch',
    contact_hero_sub:      'Whether you\'re a retailer, a bar owner, press, or simply a tequila lover — the flight begins with a conversation.',
    contact_info_eyebrow:  'Contact information',
    contact_find_us:       'Find us',
    contact_address_label: 'Address',
    contact_email_label:   'Email',
    contact_follow_label:  'Follow us',
    contact_welcome:       'We welcome enquiries from',
    contact_type1_title:   'Retailers & distributors',
    contact_type1_desc:    'Looking to stock Hermanos AVE in your store or portfolio',
    contact_type2_title:   'Bars & restaurants',
    contact_type2_desc:    'Adding a premium Mexican tequila to your back bar',
    contact_type3_title:   'Press & media',
    contact_type3_desc:    'Press samples, interviews, and brand stories',
    contact_type4_title:   'Events & collaborations',
    contact_type4_desc:    'Tastings, brand activations, and special occasions',
    contact_form_header:   'Send a message',
    contact_first_name:    'First name',
    contact_last_name:     'Last name',
    contact_email_lbl:     'Email address',
    contact_company:       'Company / Organisation (optional)',
    contact_enquiry_type:  'Nature of enquiry',
    contact_select:        'Select one...',
    contact_opt_retail:    'Retail / Distribution',
    contact_opt_bar:       'Bar / Restaurant',
    contact_opt_press:     'Press / Media',
    contact_opt_events:    'Events / Collaborations',
    contact_opt_general:   'General enquiry',
    contact_message_lbl:   'Your message',
    contact_legal_text:    'I confirm I am of legal drinking age and agree to be contacted by Hermanos AVE regarding my enquiry. We will not share your information with third parties.',
    contact_send:          'Send message',
    contact_success_title: 'Message received',
    contact_success_body:  'Thank you for reaching out. We\'ll be in touch shortly. In the meantime, welcome to the flight.',
  ...
  es: {
    ...
    /* PRODUCTS PAGE */
    prod_hero_eyebrow: 'Nuestras expresiones',
    prod_hero_title:   'Dos tequilas, un alma',
    prod_hero_sub:     'Cada botella es un viaje — desde los campos de agave de Jalisco hasta tu copa.',
    silver_edition:    'Edición Silver',
    silver_label:      'Edición Silver · Etiqueta Azul',
    silver_desc:       'Sin añejar y sin disculpas, nuestro Silver captura el alma pura del agave azul. Cristalino y brillantemente fresco — este es el tequila en su forma más natural. Notas de cítricos y flores danzan libremente, como las aves que inspiraron nuestro nombre, listas para alzar vuelo en tu paladar.',
    ...
    note_citrus:       'Cítrico',
    note_floral:       'Floral',
    note_fresh_agave:  'Agave Fresco',
    note_herbal:       'Herbal',
    note_clean:        'Final Limpio',
    note_vanilla:      'Vainilla',
    note_oak:          'Roble Tostado',
    note_caramel:      'Caramelo',
    note_agave:        'Agave',
    note_smoke:        'Humo Suave',
    spec_agave:        'Agave',
    spec_agave_val:    '100% Blue Weber',
    spec_origin:       'Origen',
    spec_origin_val:   'Jalisco, México',
    spec_style:        'Estilo',
    spec_style_val:    'Sin añejar / Blanco',
    spec_cert:         'Certificación',
    repo_label:        'Edición Reposado · Etiqueta Oscura',
    repo_desc:         'Añejado en barricas de roble seleccionadas, nuestro Reposado reposa hasta alcanzar el equilibrio perfecto entre el carácter del agave y la calidez de la madera. El resultado es un espíritu suave y ambarino con capas de complejidad — un tequila que honra la paciencia del artesano.',
    repo_unavailable:  'Actualmente no disponible',
    repo_soldout:      'Agotado',
    repo_ageing:       'Añejamiento',
    repo_ageing_val:   'Barricas de roble',
    repo_notify:       'Avísame cuando esté disponible',
    repo_coming_soon:  'Vuelve pronto',
    lifestyle_eyebrow: 'Nacido en Jalisco',
    lifestyle_title:   'Donde la tradición<br>alza el vuelo',
    lifestyle_body:    'Elaborado en el corazón de la región tequilera de México, donde el agave crece bajo cielos abiertos y cada botella lleva el espíritu de la tierra.',
    lifestyle_cta:     'Nuestra historia',
    ...
    prod_cta_title:    'Hablemos',
    prod_cta_btn:      'Contáctanos',

    /* CONTACT PAGE */
    contact_hero_eyebrow:  'Nos encantaría saber de ti',
    contact_hero_title:    'Contáctanos',
    contact_hero_sub:      'Ya seas distribuidor, dueño de bar, prensa o simplemente un amante del tequila — el vuelo comienza con una conversación.',
    contact_info_eyebrow:  'Información de contacto',
    contact_find_us:       'Encuéntranos',
    contact_address_label: 'Dirección',
    contact_email_label:   'Correo electrónico',
    contact_follow_label:  'Síguenos',
    contact_welcome:       'Recibimos consultas de',
    contact_type1_title:   'Minoristas y distribuidores',
    contact_type1_desc:    'Interesados en tener Hermanos AVE en su tienda o portafolio',
    contact_type2_title:   'Bares y restaurantes',
    contact_type2_desc:    'Añadir un tequila mexicano premium a su barra',
    contact_type3_title:   'Prensa y medios',
    contact_type3_desc:    'Muestras de prensa, entrevistas e historias de marca',
    contact_type4_title:   'Eventos y colaboraciones',
    contact_type4_desc:    'Catas, activaciones de marca y ocasiones especiales',
    contact_form_header:   'Envíanos un mensaje',
    contact_first_name:    'Nombre',
    contact_last_name:     'Apellido',
    contact_email_lbl:     'Correo electrónico',
    contact_company:       'Empresa / Organización (opcional)',
    contact_enquiry_type:  'Tipo de consulta',
    contact_select:        'Selecciona una opción...',
    contact_opt_retail:    'Distribución / Minorista',
    contact_opt_bar:       'Bar / Restaurante',
    contact_opt_press:     'Prensa / Medios',
    contact_opt_events:    'Eventos / Colaboraciones',
    contact_opt_general:   'Consulta general',
    contact_message_lbl:   'Tu mensaje',
    contact_legal_text:    'Confirmo que soy mayor de edad legal para beber y acepto ser contactado por Hermanos AVE respecto a mi consulta. No compartiremos tu información con terceros.',
    contact_send:          'Enviar mensaje',
    contact_success_title: 'Mensaje recibido',
    contact_success_body:  'Gracias por contactarnos. Estaremos en touch pronto. Mientras tanto, bienvenido al vuelo.',
