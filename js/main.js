...
document.addEventListener('DOMContentLoaded', () => {
      ...
      noBtn.addEventListener('click', () => {
        document.body.innerHTML = `
          <div style="min-height:100vh;background:#0e1a0a;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:2rem;font-family:'Montserrat',sans-serif;">
            <p style="color:rgba(240,234,216,0.4);font-size:1.1rem;letter-spacing:3px;">We\'re sorry, this content is not available in your region or for your age.</p>
          </div>`;
      });
    }
  }
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      try {
        const response = await fetch('https://formspree.io/f/mdabewoj', {
          method: 'POST',
